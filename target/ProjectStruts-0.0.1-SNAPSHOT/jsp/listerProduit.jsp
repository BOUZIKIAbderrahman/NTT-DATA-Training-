				...
				<tbody>
					<s:iterator value="listProduits">
						<tr>
							...
							<td><s:form method="get" action="supprimerProduit"
									enctype="multipart/form-data" validate="true">
									<s:submit type="button" name="Submit" value="Delete"
										class="btn btn-danger" labelposition="left">
										<s:param name="idProduit" value="%{#categorie.idProduit}" />
									</s:submit>
								</s:form></td>
						</tr>
					</s:iterator>
